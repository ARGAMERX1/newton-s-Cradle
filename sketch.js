...
function setup() {
	...
	line1 = new Rope(roof.body,ball1.body,{x:200, y:200});
	line2 = new Rope(roof.body,ball2.body,{x:250, y:250});
	line3 = new Rope(roof.body,ball3.body,{x:300, y:300});
	line4 = new Rope(roof.body,ball4.body,{x:350, y:350});
	line5 = new Rope(roof.body,ball5.body,{x:400, y:400}); 
